-- #######################################################################################
-- CONVERTED FROM hyprland.conf (hyprlang) TO hyprland.lua (Hyprland 0.55+ Lua config)
-- #######################################################################################

-- hl.config({ autogenerated = true }) -- remove/omit this to remove the yellow warning
...
-- Note: permission changes require a Hyprland restart, they are not applied on-the-fly
hl.config({
    ecosystem = {
...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("grim ~/Pictures/screenshot_$(date +%s).png"))
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("grim -g \"$(slurp)\" ~/Pictures/screenshot_$(date +%s).png"))
